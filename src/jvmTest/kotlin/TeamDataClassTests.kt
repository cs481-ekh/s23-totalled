...
class TeamDataClassTests {
    ...
    val item1 = LineItem(12.00, 0.00, "Sheet Metal", "1/2/2023", "Home Depot", CardType.AH, PurchaseType.PURCHASE, "team-001")
    val item2 = LineItem(0.00, 1000.00, "Sponsor Fee", "8/1/2022", "MBE", CardType.NONE, PurchaseType.SERVICE, "team-001")
    val item3 = LineItem(12.00, 3.50, "Piping", "1/3/23", "PipesUSA.Com", CardType.RMB, PurchaseType.PURCHASE, "team-001")
    val item4 = LineItem(0.00, 140.0, "Hotel Stay", "12/25/23", "Marriott", CardType.TRV, PurchaseType.TRAVEL, "team-001")
    val teamName = "Team1"
    ...
    fun initVariables() {
        ...
        expectedToString = String.format(
            "Team(teamName=Team1, lineItemList=[LineItem(totalTaxable=12.0, totalNonTaxable=0.0," +
                " description=Sheet Metal, date=1/2/2023, vendor=Home Depot, cardType=AH, purchaseType=PURCHASE, poNumber=team-001)," +
                " LineItem(totalTaxable=0.0, totalNonTaxable=1000.0, description=Sponsor Fee, date=8/1/2022," +
                " vendor=MBE, cardType=NONE, purchaseType=SERVICE, poNumber=team-001), LineItem(totalTaxable=12.0, totalNonTaxable=3.5," +
                " description=Piping, date=1/3/23, vendor=PipesUSA.Com, cardType=RMB, purchaseType=PURCHASE, poNumber=team-001)]," +
    ...
    fun teamExists_AddNewLineItemToList_CorrectLineItemListPrints() {
        ...
        expectedToString = String.format(
            "Team(teamName=Team1, lineItemList=[LineItem(totalTaxable=12.0, totalNonTaxable=0.0," +
                ...
                " vendor=Marriott, cardType=TRV, purchaseType=TRAVEL, poNumber=team-001)]," +
                " totalTaxable=0.0, totalShippingHandling=0.0, totalServices=0.0, totalTravel=0.0, totalTaxes=0.0," +
                " totalCharges=0.0)",
        )
